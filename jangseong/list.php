...
<body onLoad="noBack();" onpageshow="if (event.persisted) noBack();">
    ...
    // Look for a GET variable page if not found default is 1.
                ...
                <tr>
                    ...
                    <td id="cot"><a href="view.php?memID=<?php echo $row['memID']; ?>" class="btn btn-primary btnfix" style="" >상세정보</a> <a href="edit.php?id=<?php echo $memberID ?>" class="btn btn-warning btnfix" style="color:white; float:left; margin-right:20px; position:relative; " >수정</a></td>
             </tr>
