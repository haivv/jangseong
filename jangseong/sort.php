...
<body>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <th class="listcol">이름 
                        ...
                        if($sort=="a"){
                            echo "<a href='sort.php?act=b' class='btnsort'>&#8595; </a> ";
                        }
                        else{
                            echo "<a href='sort.php?act=a' class='btnsort'>&#8593; </a> ";
                        }
                        ?>
    ...
    // Look for a GET variable page if not found default is 1.
                    ...
                    if($sort=="a"){
                        $sql = "SELECT * FROM member  ORDER BY name  ASC LIMIT $start_from, $per_page_record ";
                    }
                    else{
                        $sql = "SELECT * FROM member  ORDER BY name DESC LIMIT $start_from, $per_page_record ";
                    }
    ...
    <div    class="container">
        <ul class="pagination  justify-content-center"  >
            ...
            <?php
                ...
                if($page>=2){
                    if($sort=="a"){
                        echo "<li class='page-item' ><a class='page-link' id='paging-left' href='sort.php?page=".($page-1)."&act=a'>  이전 </a></li>";
                    }
                    else{
                        echo "<li class='page-item' ><a class='page-link' id='paging-left' href='sort.php?page=".($page-1)."&act=b'>  이전 </a></li>";
                    }
                }
                ...
                for ($i=1; $i<=$total_pages; $i++) {
                    if ($i == $page) {
                        if($sort=="a"){
                            $pagLink .= "<li class='page-item active'><a class = 'page-link' href='sort.php?page=".$i."&act=a'>".$i." </a></li>";
                        }
                        else{
                            $pagLink .= "<li class='page-item active'><a class = 'page-link' href='sort.php?page=".$i."&act=b'>".$i." </a></li>";
                        }
                        
                    }
                    else  {
                        if($sort=="a"){
                            $pagLink .= "<li class='page-item '><a class='page-link' href='sort.php?page=".$i."&act=a'> ".$i." </a></li>";
                        }
                        else{
                            $pagLink .= "<li class='page-item '><a class='page-link' href='sort.php?page=".$i."&act=b'> ".$i." </a></li>";
                        }
                    }
                }
                ...
                if($page<$total_pages){
                    if($sort=="a"){
                        echo "<li class='page-item'><a class='page-link' href='sort.php?page=".($page+1)."&act=a'>  다음 </a></li>";
                    }
                    else{
                        echo "<li class='page-item'><a class='page-link' href='sort.php?page=".($page+1)."&act=b'>  다음 </a></li>";
                    }
                }
